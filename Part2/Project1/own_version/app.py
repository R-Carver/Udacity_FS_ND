...
def venues():
  ...
  #test count
  #shows = Show.query.filter(Show.start_time > '2020-01-25').all()
  #print(shows)

  """ shows = Show.query.filter(Show.venue_id == 3, Show.start_time > '2020-01-25').all()
  print(shows)
  print(len(shows)) """
...
def show_venue(venue_id):
  ...
  for show in pastShows:
    artist = Artist.query.filter_by(id=show.id).first()
